...
const FarmMitraLearningHub = () => {
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const responses = [
        'Rice husk is excellent for making biofuel and organic compost. The potential income is ₹8,000-12,000 per ton. Would you like to know more about the process?',
        'Sugarcane bagasse can be converted into paper, biofuel, and construction materials. This can generate significant revenue streams for farmers.',
        'Carbon credits can earn you ₹5,000-15,000 per acre annually through sustainable practices. I can guide you through the certification process.',
        'The FarmMitra platform connects you directly with buyers. Registration is free and you can start selling within 24 hours. Need help getting started?',
        'Organic certification can increase your product value by 20-40%. The process takes 3-6 months but the returns are substantial.',
        'Crop residue burning releases 149 million tons of CO2 annually in India. Converting this to biofuel could generate ₹50,000 crores in revenue!'
      ];
